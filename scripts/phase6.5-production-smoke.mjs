...
for(const [id,query,sourceId,chapterId] of [['weebcentral','One Piece',null,null],['mangapill','One Piece','2/one-piece',null],['kaliscan','solo','26690-solo-max-level-newbie','1'],['mangajinx','solo','26690-solo-max-level-newbie','1'],['gdscans','sage','sage-0-power',null]].filter(included))await record(id,async()=>{
