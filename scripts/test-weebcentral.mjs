/**
 * Test script to verify Weeb Central accessibility
 */

const WEEB_CENTRAL_BASE = 'https://weebcentral.com';

async function testWeebCentral() {
  console.log('=== Weeb Central Accessibility Test ===\n');

  try {
    // Test 1: Basic site access
    console.log('🔍 Test 1: Basic Site Access');
    const siteResponse = await fetch(WEEB_CENTRAL_BASE);
